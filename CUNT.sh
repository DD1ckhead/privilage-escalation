...
banner() {
  ...
  cat <<EOF
    ...
    ________ ____      _________  _____ ____________
$B | 0 0 0 0|  1 |    |  1| 2  \  | 2  | | 3 3 3  3 |
$B |  0 ____|  1 |    |  1| 2   \ | 2 |  \__     __/
$B |  0 |____  1 |____|  1| 2    \| 2 |     |  3|
$B | 0 0  0 |  1 1 1 1 1 1| 2  | \  2 |     |  3|
$B |_ ______|_____________|_2__|  \_2_|     |___|
...
$DG            \____\_______/$NC
 ...
 by stealthcopter (now with swifty tor routing and circuting)
EOF
}
